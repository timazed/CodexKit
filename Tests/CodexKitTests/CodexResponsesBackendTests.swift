        ...
        await TestURLProtocol.enqueue(
            .init(
                ...
                inspect: { request in
                    ...
                    XCTAssertTrue(developerText.contains("Context PlannerContext:"))
                    ...
                    XCTAssertFalse(developerText.contains("source of truth for this turn"))
        ...
        await TestURLProtocol.enqueue(
            .init(
                ...
                inspect: { request in
                    ...
                    let developerText = try XCTUnwrap(developerContent.first?["text"] as? String)
                    XCTAssertTrue(developerText.contains("Policy: Research the request and gather grounded information."))
                    XCTAssertTrue(developerText.contains("Research the request and gather grounded information."))
                    XCTAssertTrue(developerText.contains("Req:"))
                    ...
                    XCTAssertFalse(developerText.contains("Turn policy:"))
        ...
        await TestURLProtocol.enqueue(
            .init(
                ...
                inspect: { request in
                    ...
                    let developerContent = try XCTUnwrap(developerMessage["content"] as? [[String: Any]])
                    let developerText = try XCTUnwrap(developerContent.first?["text"] as? String)
                    XCTAssertTrue(developerText.contains("Policy:"))
                    XCTAssertFalse(developerText.contains("Schema name:"))
