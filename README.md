...
[![Version](https://img.shields.io/badge/release-2.0.0--alpha.28-orange)](https://github.com/timazed/CodexKit/releases/tag/v2.0.0-alpha.28)
...
`main` tracks the upcoming **2.0** development line; the latest prerelease is [v2.0.0-alpha.28](https://github.com/timazed/CodexKit/releases/tag/v2.0.0-alpha.28). For the stable release, use the [v1.1.0 documentation](https://github.com/timazed/CodexKit/blob/v1.1.0/README.md). Upgrading an alpha integration? Read the [migration notes](docs/migration.md).
